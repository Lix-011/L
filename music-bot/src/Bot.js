...
class Bot {
  ...
  async _handleMessage(msg) {
    ...
    if (content === 'مساعدة' || content === '؟') {
      return this._reply(msg.channel, this._helpEmbed());
    }
  }
  ...
  async _handleButton(interaction) {
    ...
    switch (interaction.customId) {
      ...
      case 'queue_list':
        await interaction.followUp({ embeds: [buildQueueEmbed(this.player.queue, this.player.currentTrack)], ephemeral: true });
        break;
      case 'stop':
